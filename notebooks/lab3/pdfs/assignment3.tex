...
\begin{itemize}
\item ATSC 409: Hand-in answers to all parts of Problem 1 from the Lab.
...
\item Take $\kappa = 0.05$ m$^2$ s$^{-1}$, $\gamma = (3600$ s$)^{-1}$, and 
\begin{equation}
\alpha(x) = \left\{ \begin{array}{cl}
\alpha_o/\Delta x,& x=x_*\\
0, & x \ne x_*\\
\end{array} \right.
\end{equation}
where you can choose the point $x_*$, $\alpha_o = 0.005$ kg m$^{-1}$ s$^{-1}$ and $\Delta x = L/N$ is your grid spacing. Find the solution (using python) for your choice of $N$ between 5 and 15.  Take the length of the hall as $L=20~m$.
