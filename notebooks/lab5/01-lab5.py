...
#         (scanned pdf in this directory: adapt_ode.pdf)
#
...
# earth.
#
# Here, we will not attempt to mathematically model such a large,
# complex system, although modern day 'Earth System Models' (ESMs) do attempt to 
# model the 'Earth System' which includes the climate and aspects of the biosphere
# What we can do here is to construct a ’toy model’
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.493997Z", "start_time": "2022-02-17T03:40:22.213290Z"} code_folding=[0] trusted=true
#
...
# %% [markdown] ExecuteTime={"end_time": "2022-02-05T01:50:27.578068Z", "start_time": "2022-02-05T01:50:27.573440Z"}
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.504206Z", "start_time": "2022-02-17T03:40:23.496511Z"} code_folding=[0] trusted=true
# define functions
import matplotlib.pyplot as plt
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.707043Z", "start_time": "2022-02-17T03:40:23.506823Z"} code_folding=[0] trusted=true
...
# %% [markdown] ExecuteTime={"end_time": "2022-02-07T19:31:15.932451Z", "start_time": "2022-02-07T19:31:15.926836Z"}
# ### Problem Conduction
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.719383Z", "start_time": "2022-02-17T03:40:23.710150Z"} code_folding=[0] trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.925942Z", "start_time": "2022-02-17T03:40:23.721788Z"} code_folding=[0] trusted=true
...
# balance. The default code below produces a steady state which arises from a given initial daisy
# population that starts with only white daisies.
#
# 1.  Add a relatively small (try 1%, 2\% and then 5\%) initial fraction of black daisies to the
...
#
# 2.  Set the initial black daisy population to 5\% (blackconc=0.05). Attempt to adjust the initial white daisy population to obtain a non-zero steady state. What value of initial white daisy population gives you a non-zero steady state for blackconc=0.05? Do you have to increase or decrease the initial fraction? What is your explanation for this behavior - provide evidence in the forms of plots, or numbers (outputs from the model).
#
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:23.936568Z", "start_time": "2022-02-17T03:40:23.927965Z"} code_folding=[0] trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:24.818994Z", "start_time": "2022-02-17T03:40:23.938484Z"} code_folding=[0] trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:24.826024Z", "start_time": "2022-02-17T03:40:24.821203Z"} code_folding=[0] trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.701593Z", "start_time": "2022-02-17T03:40:24.827927Z"} code_folding=[0] trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.859287Z", "start_time": "2022-02-17T03:40:25.705740Z"} code_folding=[0] trusted=true
...
#
# 4.  A discussion of whether adding this feedback extends the range of habital L values for which non-zero populations exist. Provide evidence for your answer.
#
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.864965Z", "start_time": "2022-02-17T03:40:25.861468Z"} trusted=true
class Integrator:
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.870243Z", "start_time": "2022-02-17T03:40:25.866862Z"} trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.874862Z", "start_time": "2022-02-17T03:40:25.872305Z"} trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.880876Z", "start_time": "2022-02-17T03:40:25.877080Z"} trusted=true
dir(the_integ)
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.886283Z", "start_time": "2022-02-17T03:40:25.882379Z"} trusted=true
vars(the_integ)
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.892154Z", "start_time": "2022-02-17T03:40:25.888471Z"} trusted=true
import inspect
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.898142Z", "start_time": "2022-02-17T03:40:25.894004Z"} trusted=true
import numpy as np
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.903481Z", "start_time": "2022-02-17T03:40:25.899897Z"} trusted=true
sample = Trig(1, 2, 3, 4)
sample.calc_trig()
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.911033Z", "start_time": "2022-02-17T03:40:25.905692Z"} trusted=true
import yaml
out_dict = dict()
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.916796Z", "start_time": "2022-02-17T03:40:25.912866Z"} trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.924798Z", "start_time": "2022-02-17T03:40:25.919000Z"} trusted=true
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.932658Z", "start_time": "2022-02-17T03:40:25.929740Z"} trusted=true
import numpy as np
...
# %% ExecuteTime={"end_time": "2022-02-17T03:40:25.938863Z", "start_time": "2022-02-17T03:40:25.934853Z"} trusted=true
